...
class GameLogic:
    ext_mode = {"descr": "EXTREME MODE", "words": 4, "seconds": 25, "struct": "sentences", "sentences" : 3, "next": None, "point_cap": 80, "warning": ext_warning, "ascii": ext_ascii, "points_per": 10}
    hard_mode = {"descr": "HARD MODE", "words": 3, "seconds": 20, "struct": "sentences", "sentences" : 1, "next": ext_mode, "point_cap": 60, "warning": hard_warning, "ascii": hard_ascii, "points_per": 10}
    ...
    easy_mode = {"descr": "EASY MODE", "words": 1, "seconds": 15, "struct": "words", "next": med_mode, "point_cap": 20, "warning": None, "ascii": easy_ascii, "points_per": 10}

    def __init__(self):
        self.lives = 3
        self.points = 0
        self.diff = self.easy_mode # potentially breaking...
